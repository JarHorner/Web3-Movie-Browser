...
const Home = (props) => {
  ...
  const { register, handleSubmit } = useForm(); //Initializes form library use
    ...
    >
      ...
      >
        <div id="content_title" className=" text-center ">
          <h1 className=" text-3xl font-bold rounded-t-lg p-3 border-b text-pink-900  bg-white ">
            Browse Movies
          </h1>
        </div>
        ...
        <div className="flex h-full ">
          <div
            id="content_title"
            className=" text-center flex-1 bg-pink-700 f-full flex items-center flex-col "
          >
            <FilmIcon className=" w-1/2 text-pink-50" />
            <h1 className="text-lg p-3 text-white">
              {" "}
              Use the searchbar to search for matching movies or browse all our
              movies by clicking on the button.
            </h1>
          </div>
          ...
          >
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className=" flex items-center bg-pink-700 w-96 rounded-lg ">
                {/* Title */}
                <label
                  className="text-lg  font-bold px-2 text-white "
                  htmlFor="movieTitle "
                >
                  Title
                </label>
