  ...
  return (
    <div className="flex m-2 bg-white p-2 rounded-lg ">
        <div className="flex flex-1 w-[14%] justify-center">
            <img className="rounded-lg" src={"https://image.tmdb.org/t/p/w92" + props.movie.poster} alt={props.movie.title} ></img>
        </div>
        
        <div className="flex flex-1 w-[14%] items-center ">
            <h1 className="text-xl ">{props.movie.title}</h1>
        </div>
        <div className="flex flex-1 w-[14%] items-center ">
            <h1 className="text-xl ">{props.movie.release_date}</h1>
        </div>
        <div className="flex flex-1 w-[14%] items-center">
