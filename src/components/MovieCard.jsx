const MovieCard = (props) => {
  ...
  return (
    <div className="flex m-2 bg-white p-2 rounded-lg">
      ...
      <div className="flex flex-1 w-[14%] items-center">
        <button className="text-xl bg-white border py-1 px-3 rounded-lg text-neutral-400 hover:border-none hover:drop-shadow-xl hover:scale-110 hover:text-pink-500 transition-all">
          ♥
        </button>
      </div>
